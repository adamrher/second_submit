...
\end{tabular}
\end{center}
\caption{(Top) 1979-1998 bias in northern hemisphere summer snow cover (fraction) relative to ERA4. (Middle and bottom) 1979-1998 summer albedo bias (fraction), computed as the difference (middle) from RACMO2.3p2, and (bottom) the MODIS dataset of \citeA{MODIS}. As all observational datasets in this plot are on high-resolution grids, they've all been mapped to the individual model grids, before taking differences.}
\label{fig:alb}
\end{figure}
